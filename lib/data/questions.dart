...
//First answer is correct in list
const questions = [
  ...
  QuizQuestion(
      'Which widget should you try use more often: StatelessWidget or StatefulWidget?', [
        'StatelessWidget',
        'StatefulWidget',
        'Both are equally good',
        'None of the above',
      ]),
  QuizQuestion('What happens if you change the data in a StatelessWidget? ', [
